...
rmax = args.rMax
extra='--robustFit=1'
# --init-params <json>: seed the FitDiagnostics minimization with parameter values
# harvested from healthy standalone fits (fitparams.json). The 2425 combined
...
import os as _os
_ip = _os.environ.get("TTBAR_INIT_PARAMS")
if _ip and _os.path.exists(_ip):
    import json as _json
    _vals = _json.load(open(_ip))
