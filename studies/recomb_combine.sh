...
CEN_BASE="output_recomb_ttag/ttbarfits_cen2024_${CEN_ORDER:?set CEN_ORDER}"
FWD_BASE="output_recomb_ttag/ttbarfits_fwd2024_${FWD_ORDER:?set FWD_ORDER}"
...
COMB_DIR="output_recomb_ttag/cards_combined_24_recomb_ttag${COMB_SUFFIX:-}"
