...
MATRIX = HERE / "workspace_fullsyst_canary_v1.tsv"
SUBMIT = HERE / "workspace_portable_fullsyst_canary_v1.sub"
...
def main() -> int:
    ...
    assert "workspace_fullsyst_canary_v1.tsv" in submit

    remap_template = (
        "fullsyst_canary_v1/workspaces/portable_results/"
    ...
    assert remaps == {
        "fullsyst_canary_v1/workspaces/portable_results/cen2425_w1_m2000.tgz",
        "fullsyst_canary_v1/workspaces/portable_results/fwd2425_w1_m2000.tgz",
    }
    assert len(remaps) == 2

    print("WORKSPACE_FULLSYST_CANARY_V1_CONTRACT_TEST_OK")
    return 0
