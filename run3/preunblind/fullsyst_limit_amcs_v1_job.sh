...
MASS="$3"
RMAX="$4"
case "${MODE}" in fullsyst_limit_amcs_v1) ;; *) echo "bad mode" >&2; exit 4 ;; esac
...
RESULT="${SCRATCH}/fullsyst_limit_amcs_v1_result"
RESULT_ARCHIVE="${SCRATCH}/fullsyst_limit_amcs_v1_result.tgz"
...
finalize_result() {
    ...
    {
        echo "campaign=fullsyst_limit_amcs_v1"
        echo "exit_code=${rc}"
...
(
    ...
    # 2026-08-14 decision: Barlow-Beeston-lite for signal+ttbar template bins
    echo "* autoMCStats 0 1 1" >> "${SIGNAL}_card_combined.txt"
