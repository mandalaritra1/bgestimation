#!/bin/bash
# Portable Asimov injection worker (v15 = v14 with the strategy-2 primary minimizer (matches the validated
# stage-2 recipe; strategy 1 stopped at EDM ~0.04 vs the 0.01 gate), run on
