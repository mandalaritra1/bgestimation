...
MASS="$3"
RMAX="$4"
case "${MODE}" in fullsyst_limit_v2) ;; *) echo "bad mode" >&2; exit 4 ;; esac
...
RESULT="${SCRATCH}/fullsyst_limit_v2_result"
RESULT_ARCHIVE="${SCRATCH}/fullsyst_limit_v2_result.tgz"
...
finalize_result() {
    ...
    {
        echo "campaign=fullsyst_limit_v2"
        echo "exit_code=${rc}"
